...
import { fetchIngredients, deleteIngredient } from '../../../store/slices/ingredientSlice';
...
const IngredientList = () => {
  ...
  const handleDeleteConfirm = async () => {
    if (selectedIngredient) {
      await dispatch(deleteIngredient(selectedIngredient.id));
      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            A list of all ingredients in the system including their name, price, and stock.
          </p>
        </div>
